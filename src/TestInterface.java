...
public class TestInterface extends JFrame {
    ...
    public class MainPanel extends JPanel {
        ...
        MainPanel() {
            ...
            JLabel title = 
                new JLabel("<html><h1><i><strong>Welcome to Store Manager!</strong></i></h1></html>");
            JLabel create = 
                new JLabel("<html><h3><strong><center><p>Let's first create your store.</p>"
    ...
    public class mainPage extends JPanel {
        mainPage() {
            ...
            JLabel title = 
                new JLabel("<html><h3><strong><center>This is your store:</center></strong></h3><hr><br></html>");
            main.add(title, c);
            ...
            JLabel titleAdd = 
                new JLabel("<html><h3><strong>Add a product:</h3></strong><hr></html>", 
            ...
            JLabel titleEdit = 
                new JLabel("<html><h3><strong>Edit product price:</h3></strong><hr></html>", 
                    SwingConstants.CENTER);
            ...
            editProdBtn.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    String sDate = dateFormat.format(date);
                    Notification n = 
                        new Notification(sDate, NotificationType.MODIFY, d.getID(), eModified.getID());
                    d.notifyAllObservers(n);
                    main.setVisible(true);
        ...
        public void renderCart() {
            // boxlayout for vertical display
            cartPanel.setLayout(new BoxLayout(cartPanel, BoxLayout.Y_AXIS)); 

            JLabel cartTitle = 
                new JLabel("<html><h3><strong>Modify ShoppingCart</h3><hr></strong></html>");
            ...
            JLabel addToCartTitle = 
                new JLabel("<html><h3><strong>Select a product:</h3></strong><hr></html>");
            ...
            addToCartBtn.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    Item eNewToAdd = 
                        new Item(itemToAdd.getName(), itemToAdd.getID(), itemToAdd.getPrice());
                    sCart.add(eNewToAdd);
                    cartItems.clear();
                    ListIterator it = sCart.listIterator();
                    while(it.hasNext()) {
        ...
        public void renderWish() {
            ...
            JLabel wishTitle = 
                new JLabel("<html><h3><strong>Modify WishList</h3><hr></strong></html>");
        ...
        public void renderNotif() {
            ...
            JLabel notifTitle = 
                new JLabel("<html><h3><strong>These are your notifications:</h3><hr></strong></html>");
    ...
    public class ItemRenderer extends JPanel implements ListCellRenderer<Item> {
        ...
        public Component getListCellRendererComponent(JList<? extends Item> list, 
            ...
            department.setText("Department: " + 
                ((Department)store.getDepWithItemID(item.getID())).getName());
